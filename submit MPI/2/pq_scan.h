...
static constexpr size_t N_PROBE         = 20;
...
static constexpr int HNSW_M           = 64;
static constexpr int HNSW_EFC         = 800;
static constexpr int HNSW_EFSEARCH    = 500;

static constexpr size_t RERANK_FACTOR = 10;
